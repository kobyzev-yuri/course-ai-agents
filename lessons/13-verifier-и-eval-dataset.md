# Урок 13. Verifier и eval dataset
...
## Цель урока
Измерять качество labels на исторических/учебных новостях.

## Входное состояние проекта
Файлы, которые ученик должен открыть перед занятием: `evals/run_eval.py, evals/expected_labels.jsonl`.
...
## Ожидаемый результат
Eval score воспроизводим и объясняет misses.
