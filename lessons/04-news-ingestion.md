...
## Цель урока
Научиться загружать и нормализовать новости из JSONL и будущих внешних источников.

## Входное состояние проекта
Файлы, которые ученик должен открыть перед занятием: `src/news_impact/ingestion.py, data/sample_news.jsonl`.
...
## Ожидаемый результат
Пайплайн читает новости и фильтрует по chip tickers.
